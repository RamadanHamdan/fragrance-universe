        ...
        <div class="container mx-auto px-4">
            <div class="flex justify-between items-center">
                <div class="flex items-center">
                    <img src="./storage/header.png" alt="Perfume Finder logo - a minimalist bottle icon with pink gradient" class="h-10 mr-3">
                    <h1 class="text-2xl font-bold">Fragrance Universe</h1>
                </div>
                <nav>
