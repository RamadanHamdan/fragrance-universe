                            ...
                            <form class="p-4 md:p-5">
                                <div class="grid gap-4 mb-4 grid-cols-2">
                                    <div class="col-span-2">
                                        <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-black">Perfume Name</label>
                                    ...
                                    <div class="col-span-2 sm:col-span-1">
                                        ...
                                        <input type="text" name="top-notes" id="top-notes" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-black dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Type top notes" required="">
                                    </div>
                                    <div class="col-span-2 sm:col-span-1">
                                        <label for="middle-notes" class="block mb-2 text-sm font-medium text-gray-900 dark:text-black">Middle Notes</label>
                                        <input type="text" name="middle-notes" id="middle-notes" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-black dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Type middle notes" required="">
                                    </div>
                                    <div class="col-span-2 sm:col-span-1">
                                        <label for="best-notes" class="block mb-2 text-sm font-medium text-gray-900 dark:text-black">Best Notes</label>
                                        <input type="text" name="best-notes" id="best-notes" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-black dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Type best notes" required="">
                                    </div>
                                    <div class="col-span-2 sm:col-span-1">
                                    ...
                                    <div class="col-span-2 sm:col-span-1">
                                        ...
                                        <select id="category" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-black dark:focus:ring-primary-500 dark:focus:border-primary-500">
